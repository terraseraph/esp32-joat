...
Topics used: `io/gpio`, `io/pwm`, `io/adc` (live samples while any live sink), `io/servo`, `io/rfid` (UID present/absent), `io/env` (BME280 T/P/RH), `net`, `mqtt/reconfigure`, `identity/rename`, `telemetry`.
...
io_gpio, io_pwm, io_adc, io_servo, mod_mfrc522, mod_bme280, network, command_router (mqtt reconfigure, io.hydrate), mqtt_manager, telemetry, web_server, serial_session.
